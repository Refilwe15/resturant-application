...
import { API_BASE_URL, FOODS_API } from "../../config/api";
  ...
  useEffect(() => {
    const fetchFoods = async () => {
      try {
        ...
        console.log("fetchFoods data", data);
        ...
        data.forEach((item: any) => {
          ...
          else console.warn("Unknown food type:", item.type);
        });

        console.log("categorized foods", categorized);
      ...
      {cart.length > 0 && (
        ...
        >
          <View style={styles.cartBtnContent}>
            ...
            <Text style={styles.cartText}>View Cart ({cart.length} items)</Text>
          </View>
        </TouchableOpacity>
      )}
